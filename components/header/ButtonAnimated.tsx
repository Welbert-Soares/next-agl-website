...
const ButtonAnimated = () => {
  return (
    <div className="social flex flex-row justify-center items-center gap-4">
      ...
      <section className="facebook flex justify-center items-center ">
        <button className="group flex justify-center p-2 rounded-md drop-shadow-xl from-gray-800 bg-blue-600 text-white font-semibold hover:translate-y-3 hover:rounded-[50%] transition-all duration-500 hover:from-[#331029] hover:to-[#310413]">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="1em"
            height="1.1em"
      ...
      <a
        href="https://www.instagram.com/associacaoagl/"
        target="_blank"
        rel="noopener noreferrer"
      >
        <section className="flex justify-center items-center">
